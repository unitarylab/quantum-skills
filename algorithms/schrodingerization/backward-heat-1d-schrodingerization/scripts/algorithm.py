"""1D Backward Heat Equation via Schrodingerization — u_t = -kappa * u_xx.

Compares classical Schrodingerization solver with Trotter quantum circuit.
The backward heat equation is ill-posed; Schrodingerization stabilises it.
"""
...
def main():
    ...
    dt_trotter = T / Nt
    tdiff = -kappa * TDiff(nx, dx, order=2, scheme="central", boundary="dirichlet")
